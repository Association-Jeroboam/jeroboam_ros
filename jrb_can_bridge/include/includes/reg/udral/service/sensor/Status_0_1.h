...
// Source file:   /home/thomas/git/CyphalDemo/public_regulated_data_types/reg/udral/service/sensor/Status.0.1.dsdl
// Generated at:  2022-05-08 12:36:34.961656 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 434322821,
              "/home/thomas/git/CyphalDemo/public_regulated_data_types/reg/udral/service/sensor/Status.0.1.dsdl is trying to use a serialization library that was compiled with "
    ...
    const reg_udral_service_sensor_Status_0_1* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated uint32 error_count
        ...
        (void) memmove(&buffer[offset_bits / 8U], &obj->error_count, 4U);
        offset_bits += 32U;
    }
    ...
    reg_udral_service_sensor_Status_0_1* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // uavcan.si.unit.duration.Scalar.1.0 data_validity_period
    {
        ...
        const int8_t _err4_ = uavcan_si_unit_duration_Scalar_1_0_deserialize_(
    ...
    // uavcan.si.unit.temperature.Scalar.1.0 sensor_temperature
    {
        ...
        const int8_t _err5_ = uavcan_si_unit_temperature_Scalar_1_0_deserialize_(
